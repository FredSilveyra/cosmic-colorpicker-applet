...
### Changed
- Color picking now runs in a helper process (`cosmic-colorpicker-applet --pick`) that connects directly to `cosmic-comp` and draws a full-screen layer-shell overlay.
...
[1.0.0]: https://github.com/fredsilveyra/cosmic-colorpicker-applet/compare/v0.1.0...v1.0.0
[0.1.0]: https://github.com/fredsilveyra/cosmic-colorpicker-applet/releases/tag/v0.1.0
